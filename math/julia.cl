...
__kernel void julia_kernel(
    ...
    double z_real = x_min + gid_x * x_step;
    double z_imag = y_min + gid_y * y_step;
    double c_real = z_real_offset;
    double c_imag = z_imag_offset;

    int iteration = 0;
    double zr2 = z_real * z_real;
    double zi2 = z_imag * z_imag;
